...
sudo scutil --set ComputerName "mrp's Macbook"
sudo scutil --set HostName "mrp's Macbook"
sudo scutil --set LocalHostName "mrps-macbook"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "mrp's Macbook"
...
# NOT WORKING: need to disable SIP: https://github.com/mathiasbynens/dotfiles/issues/587

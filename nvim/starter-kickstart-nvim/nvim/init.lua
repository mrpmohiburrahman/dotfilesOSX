...
require('lazy').setup({'ldelossa/nvim-ide', -- Add nvim-ide plugin
'nvim-lua/plenary.nvim', 'MunifTanjim/nui.nvim', 'nvim-tree/nvim-web-devicons', -- Optional, for file icons
-- Add other plugins here...
-- Example of how to add other plugins
'tpope/vim-sleuth', {
...
require('ide').setup({
    ...
    components = {
        global_keymaps = {
            -- customize global keymaps if needed
        }
    },
    panels = {
        left = "explorer",
...
-- The rest of your init.lua configuration...
